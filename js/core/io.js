...
io.on('connection', (socket) => {
  ...
  socket.on('login', async ({ name, room }) => {
    ...
    // const responseUser = await axios.get('http://localhost/sw1-p2-modelo-c4/public/api/user/' + name);
    const responseUser = await axios.get(variables.app+'/api/user/' + name);
    ...
    // const responseProject = await axios.get('http://localhost/sw1-p2-modelo-c4/public/api/cargar-diagrama/' + room);
    const responseProject = await axios.get(variables.app + '/api/cargar-diagrama/' + room);
  ...
  socket.on('save_component', async (data) => {
    ...
    if (findRoom(data.room)) {
      ...
      // const response = await axios.put('http://localhost/sw1-p2-modelo-c4/public/api/guardar-diagrama/' + data.room, body);
      const response = await axios.put(variables.app + '/api/guardar-diagrama/' + data.room, body);
